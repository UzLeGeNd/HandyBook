...
import com.example.handybook.databinding.FragmentSecondSplashBinding
 ...
 * Use the [SecondSplashFragment.newInstance] factory method to
        ...
        if(user == null){
            handler.postDelayed({
                parentFragmentManager.beginTransaction()
                    .replace(R.id.main, FirstEnterFragment())
                    .commit()
            }, 2000)
        }else{
            handler.postDelayed({
